    ...
    <div className='introductionMainContainer'>
        ...
        <div className='introContent'>
            <div className='introContent1'>
                ...
                <p>An innovative AI platform that analyzes bioacoustic data (like coughs and breathing) to detect and monitor health conditions, offering a non-invasive, intuitive approach to healthcare.</p>
            ...
            <div className='introContent2'>
                ...
                <p>Early detection and continuous monitoring of health conditions, transforming sound into actionable insights for better global health outcomes.</p>
                <img className='introLine' src={line}></img>
            </div>
            <div className='introContent3'>
                <img className='introLine' src={line}></img>
                <p>User-Friendly Design: Intuitive interface that simplifies complex health information.</p>
                <img className='introImage' src={image1}></img>
                <h1>003.</h1>
            </div>
        </div>
